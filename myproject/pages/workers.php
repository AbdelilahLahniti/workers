...
<body>
    ...
    <div class="container-fluid row">
        <aside class="aside col-2">
            <nav class="navbar navbar-expand-md menuAside position-fixed">
                ...
                <div class="collapse navbar-collapse" id="navbarSupported">
                    <ul class="list-unstyled py-3 px-lg-2">
                        <li class="fs-5 py-2">
                        ...
                        <li class="nav-item dropdown  py-2">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                ?>
                                    <li><a class="dropdown-item" href="category.php?specialty=<?php echo $row['specialty'] ?>"> <?php echo $row['specialty'] ?></a></li>
                                <?php } ?>
                            </ul>
                        </li>
        ...
        <div class="container col-10 workers pt-2 pt-lg-0">
            <h1 class="text-center my-5 title">All workers</h1>
